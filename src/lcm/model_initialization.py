...
def initialize_model_functions(model: Model) -> None:
    ...
    try:
        ...
        _set_frozen_attr(model, "internal_model", internal_model)
        _set_frozen_attr(model, "params_template", internal_model.params)
        ...
        _set_frozen_attr(model, "state_action_spaces", state_action_spaces)
        _set_frozen_attr(model, "state_space_infos", state_space_infos)
        _set_frozen_attr(model, "max_Q_over_a_functions", max_Q_over_a_functions)
        _set_frozen_attr(
            model,
