...
from lcm.typing import RegimeName, Int1D
...
def create_regime_state_action_space(regime_name: RegimeName, states: dict[str,Array],internal_regime: InternalRegime, subjects_in_regime: Int1D, *, is_last_period: bool ):
