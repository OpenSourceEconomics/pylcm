...
def validate_V(
    *,
    ...
    The NaN reduction stays sharded via `v_array_has_nan` (jit-wrapped
    so GSPMD partitions it across the V-array's devices instead of
    gathering V onto the default device).
