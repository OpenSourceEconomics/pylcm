...
def _candidate_terms(*, block: FloatND, live: BoolND, flat: Float1D) -> _CandidateTerms:
    ...
    # exactly `0.0` and the interpolant collapsed onto its left value. Rounds 9
    # to 13 answered that by LIFTING, never lowering, and asserted that
    ...
    # names and not its siblings is exactly how the previous nine rounds
    # each ended.
    #
