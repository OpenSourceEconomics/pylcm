...
Detailed old → new path mapping for tracing git history across the restructuring.
Use `git log --follow <new-path>` to trace a file's history through the rename.
...
| `src/lcm/functools.py` | `src/lcm/_utils/functools.py` |
| `src/lcm/dispatchers.py` | `src/lcm/_utils/dispatchers.py` |
| `src/lcm/state_action_space.py` | `src/lcm/_utils/state_action_space.py` |
| `src/lcm/error_handling.py` | `src/lcm/_utils/error_handling.py` |
| `src/lcm/logging.py` | `src/lcm/_utils/logging.py` |
...
| `src/lcm/utils.py` | `src/lcm/_utils/containers.py` | `Unset`, `ensure_containers_are_immutable`, `ensure_containers_are_mutable`, `_make_immutable`, `_make_mutable`, `find_duplicates`, `get_field_names_and_values`, `first_non_none` |
| | `src/lcm/_utils/namespace.py` | `flatten_regime_namespace`, `unflatten_regime_namespace` |
...
| `src/lcm/utils.py` | Split into `_utils/containers.py` + `_utils/namespace.py` |
