"""BQSEGM agreement with the brute oracle on the continuous tax-bracket toy.

The continuous-schedule BQSEGM path solves a piecewise-affine, continuous budget
...
def test_bqsegm_schedule_matches_brute_through_the_tax_kink_every_age():
