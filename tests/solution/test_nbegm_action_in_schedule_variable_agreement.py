"""NBEGM partitions each branch on its own breakpoints when an action shifts them.
...
breakpoint partition, not one shared across branches. NBEGM's value function must match
...
def test_nbegm_action_in_schedule_variable_matches_brute() -> None:
