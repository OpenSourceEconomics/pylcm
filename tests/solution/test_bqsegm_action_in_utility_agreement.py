"""BQSEGM binds the discrete action into period utility per branch.
...
per-cell utility. BQSEGM's value function must match a dense brute solve across the
...
def test_bqsegm_action_in_utility_matches_brute() -> None:
