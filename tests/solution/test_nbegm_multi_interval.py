"""Multi-interval NBEGM step against a dense single-period brute oracle.
...
def test_jump_step_matches_brute_through_two_additive_cliffs():
    ...
    value, _marginal, _policy = nbegm_recurring_jump_step(
        next_value=next_value_of_liquid(liquid_grid),
        next_marginal=next_marginal_of_liquid(liquid_grid),
        liquid_grid=liquid_grid,
        savings_grid=savings_grid,
...
def test_unified_step_matches_brute_through_a_jump_then_a_kink():
    ...
    value, _marginal, _policy = nbegm_unified_step(
        next_value=next_value_of_liquid(liquid_grid),
        next_marginal=next_marginal_of_liquid(liquid_grid),
        liquid_grid=liquid_grid,
        savings_grid=savings_grid,
...
def test_discrete_envelope_step_matches_brute_over_a_binary_choice():
    ...
    differently; the value is the upper envelope over the two NBEGM solves. The
    ...
    value, _marginal, _policy, choice = nbegm_discrete_envelope_step(
        next_value=next_value_of_liquid(liquid_grid),
        next_marginal=next_marginal_of_liquid(liquid_grid),
        liquid_grid=liquid_grid,
        savings_grid=savings_grid,
...
def test_discrete_envelope_step_smooths_with_an_ev1_taste_shock():
    ...
    over the per-choice NBEGM values, matching a dense brute that takes the same
    ...
    value, _marginal, _policy, _choice = nbegm_discrete_envelope_step(
        next_value=next_value_of_liquid(liquid_grid),
        next_marginal=next_marginal_of_liquid(liquid_grid),
        liquid_grid=liquid_grid,
        savings_grid=savings_grid,
