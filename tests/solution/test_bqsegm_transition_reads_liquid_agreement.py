"""BQSEGM handles a regime-transition probability that reads the liquid state.
...
carried-state law reads liquid. BQSEGM's value function must match a dense brute
...
def test_bqsegm_transition_prob_reads_liquid_matches_brute() -> None:
