"""NBEGM agreement with brute when the continuation reads a brute-solved child.

A NBEGM regime embedded in an otherwise-brute model transitions into brute
...
def test_nbegm_young_matches_brute_reading_a_brute_child_with_discrete_action():
