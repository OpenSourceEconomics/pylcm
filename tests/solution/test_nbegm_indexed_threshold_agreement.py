"""NBEGM agreement when a cliff threshold is read from a per-cell table.
...
entirely by the table value. The NBEGM ride-along solver must resolve each
...
from tests.test_models import nbegm_indexed_threshold_toy as toy
...
def test_nbegm_indexed_threshold_matches_brute_across_each_cliff():
