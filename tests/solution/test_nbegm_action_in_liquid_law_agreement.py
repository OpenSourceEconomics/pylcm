"""NBEGM carries a branch-specific continuation when an action shifts next liquid.
...
branches. NBEGM's value function must match a dense brute solve across the liquid
...
def test_nbegm_action_in_liquid_law_matches_brute() -> None:
