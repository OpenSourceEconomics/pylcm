"""NBEGM's discrete envelope composes with a ride-along co-state.

With a stochastic income node riding along a kink budget and a binary discrete
insurance choice, NBEGM must solve the continuous subproblem per ride cell and
...
def test_nbegm_ride_along_discrete_envelope_matches_brute_through_a_jump() -> None:
