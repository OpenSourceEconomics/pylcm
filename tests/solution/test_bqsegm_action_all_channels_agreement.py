"""BQSEGM composes all branch channels for one action at once.
...
compose: BQSEGM's value function must match a dense brute across the liquid interior.
"""
...
def test_bqsegm_action_all_channels_matches_brute() -> None:
