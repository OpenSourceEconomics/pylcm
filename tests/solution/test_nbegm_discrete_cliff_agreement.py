"""NBEGM's discrete envelope composes with a cliffed budget.

With a binary discrete insurance choice and a declared jump in the budget (a
lump tax above an exemption), NBEGM must solve the continuous subproblem
...
def test_nbegm_discrete_envelope_matches_brute_through_a_recurring_jump() -> None:
...
def test_nbegm_discrete_envelope_matches_brute_through_a_mixed_jump_and_kink() -> None:
