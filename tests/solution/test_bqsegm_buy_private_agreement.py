"""BQSEGM agreement on a binary discrete insurance choice (F-E discrete envelope).

The discrete buy-private choice shifts cash-on-hand; BQSEGM solves the continuous
...
from tests.test_models import bqsegm_buy_private_toy as toy
