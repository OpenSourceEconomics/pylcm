"""One-asset NBEGM toy with a stochastic income node riding along a tax schedule.
...
# liquid grid: an out-of-grid continuation edge-clamps, and NBEGM's savings-space
    ...
    *,
    ...
    Args:
        variant: `"brute"` drives the alive regime by `GridSearch`; `"nbegm"` by the
            `NBEGM` schedule solver, which batches the 1-D liquid step over the income
