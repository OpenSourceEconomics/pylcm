...
_SOURCE_SEALS = {
    ...
    SUPPORT_FINGERPRINT_SOURCE: "383be2f0672d1eee5742f5e7e200a15b7ece398ea67582b625ea6afb6864d923",
...
_UNIFORM_PROCESS_CONTRACTS: dict[str, tuple[str, dict[str, str]]] = {
    ...
    "src/_lcm/solution/fingerprint.py": (
        "0922e540316921e77179d59300831aa35699b1aa4b680b9c76f22ee8472f9d22",
        {
