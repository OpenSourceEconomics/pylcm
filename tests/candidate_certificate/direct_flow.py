...
_SOURCE_SEALS = {
    ...
    BACKWARD_INDUCTION_SOURCE: "d3d868944f379dd0a4ce0f54683881b7594bcd0267128fae3d11f2b6f5b42279",
    PERIOD_REPLAY_SOURCE: "ab915584dedaaf134574627540379324c53eda7692b46abd0d54fd72a2fdf459",
...
def _backward_output_layout_errors(tree: ast.Module) -> list[str]:
    ...
    errors = _exact_callable_errors(
        ...
        contracts={
            ...
            "_lowering_key": "0fb9be141e2bc360f4da38237555862841fa34d3594defd16603166771382c17",
