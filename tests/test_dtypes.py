...
def test_safe_to_int_dtype_returns_int32(value: object) -> None:
...
def test_safe_to_int_dtype_raises_on_python_int_overflow() -> None:
    """A Python int above int32 max raises `ValueError` naming the leaf."""
    with pytest.raises(ValueError, match="my_param"):
        safe_to_int_dtype(2**32, name="my_param")


def test_safe_to_int_dtype_raises_on_array_overflow() -> None:
...
def test_safe_to_int_dtype_raises_on_underflow() -> None:
